...
public class MainFrame extends JFrame {
    ...
    private void jbInit() throws Exception {
        ...
        buttonInitialState.addActionListener(new ButtonInitialState_ActionAdapter(
                this));
        ...
        buttonShowSolution.addActionListener(new ButtonShowSolution_ActionAdapter(
                this));
        ...
        comboBoxSearchMethods.addActionListener(new ComboBoxSearchMethods_ActionAdapter(
                this));
        ...
        textFieldSearchParameter.addKeyListener(new TextFieldSearchParameter_KeyAdapter(
                this));
        ...
        comboBoxHeuristics.addActionListener(new ComboBoxHeuristics_ActionAdapter(
                this));
        ...
        JPanel scrollPaneAndStatistics = new JPanel(new BorderLayout());
        scrollPaneAndStatistics.add(scrollPane, BorderLayout.NORTH);
        scrollPaneAndStatistics.add(
                buttonGenerateStatistics,
                BorderLayout.SOUTH
        );
        buttonGenerateStatistics.addActionListener(
                new ButtonGenerateStatistics_ActionAdapter(this));
        puzzlePanel.add(scrollPaneAndStatistics);
        ...
        pack();
        setMinimumSize(contentPanel.getSize());

        // TODO TEMPORARY TO ADD NIVEL ON LOAD
//        String nivelFilename = "./niveis/nivel16.txt";
//        if (nivelFilename != "") {
//            File file = new File(nivelFilename);
//            gameArea.setState(agent.readInitialStateFromFile(file));
...
//        }
    ...
    public void comboBoxSearchMethods_ActionPerformed(ActionEvent e) {
        ...
        agent.setSearchMethod((SearchMethod) comboBoxSearchMethods.getItemAt(
                index));
        ...
        textFieldSearchParameter.setEnabled(
                index == 3 || index == 7); // limited depth or beam search
        labelSearchParameter.setEnabled(
                index == 3 || index == 7); // limited depth or beam search
    }
        ...
        SwingWorker worker = new SwingWorker<Solution, Void>() {
            ...
            public Solution doInBackground() {
                ...
                try {
                    ...
                    MummyMazeProblem problem = new MummyMazeProblem((MummyMazeState) agent.getEnvironment()
                            .clone());
    ...
    public void buttonGenerateStatistics_ActionPerformed(ActionEvent e) throws IOException {
        Statistics.createStatistics(agent, textArea, this);
    }
    ...
    private void prepareSearchAlgorithm() {
        if (agent.getSearchMethod() instanceof DepthLimitedSearch) {
            ...
            searchMethod.setBeamSize(Integer.parseInt(
                    textFieldSearchParameter.getText()));
        }
    }
}
